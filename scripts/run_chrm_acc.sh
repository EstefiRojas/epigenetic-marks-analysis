...
sh chrm_acc_processing.sh ../data/lncrna-exon1-negative-control-dataset.csv lncrna-exon1-NC-histone-feature
...
sh chrm_acc_processing.sh ../data/lncrna-exon2-negative-control-dataset.csv lncrna-exon2-NC-histone-feature
...
# PROTEIN CODING
sh chrm_acc_processing.sh ../data/protein-exon2-dataset.csv protein-exon2-histone-feature
sh chrm_acc_processing.sh ../data/protein-exon2-negative-control-dataset.csv protein-exon2-NC-histone-feature

sh chrm_acc_processing.sh ../data/protein-exon3-dataset.csv protein-exon3-histone-feature
sh chrm_acc_processing.sh ../data/protein-exon3-negative-control-dataset.csv protein-exon3-NC-histone-feature

...
sh chrm_acc_processing.sh ../data/functional-lncrna-exon1-dataset.csv chrm_acc lncrna-exon1-histone-feature
sh chrm_acc_processing.sh ../data/lncrna-exon1-negative-control-dataset.csv chrm_acc lncrna-exon1-NC-histone-feature
## Process histone marks for exon2
sh chrm_acc_processing.sh ../data/functional-lncrna-exon2-dataset.csv chrm_acc lncrna-exon2-histone-feature
sh chrm_acc_processing.sh ../data/lncrna-exon2-negative-control-dataset.csv chrm_acc lncrna-exon2-NC-histone-feature
...
# PROTEIN CODING
sh chrm_acc_processing.sh ../data/protein-exon2-dataset.csv chrm_acc protein-exon2-histone-feature
sh chrm_acc_processing.sh ../data/protein-exon2-negative-control-dataset.csv chrm_acc protein-exon2-NC-histone-feature

sh chrm_acc_processing.sh ../data/protein-exon3-dataset.csv chrm_acc protein-exon3-histone-feature
sh chrm_acc_processing.sh ../data/protein-exon3-negative-control-dataset.csv chrm_acc protein-exon3-NC-histone-feature

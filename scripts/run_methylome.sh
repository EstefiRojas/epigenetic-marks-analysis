...
sh methylome_processing.sh ../data/lncrna-exon1-negative-control-dataset.csv lncrna-exon1-NC-methylome-feature
...
sh methylome_processing.sh ../data/lncrna-exon2-negative-control-dataset.csv lncrna-exon2-NC-methylome-feature
...
# PROTEIN CODING
sh methylome_processing.sh ../data/protein-exon2-dataset.csv protein-exon2-methylome-feature
sh methylome_processing.sh ../data/protein-exon2-negative-control-dataset.csv protein-exon2-NC-methylome-feature

sh methylome_processing.sh ../data/protein-exon3-dataset.csv protein-exon3-methylome-feature
sh methylome_processing.sh ../data/protein-exon3-negative-control-dataset.csv protein-exon3-NC-methylome-feature
